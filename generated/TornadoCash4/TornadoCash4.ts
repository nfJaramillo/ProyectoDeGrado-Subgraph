...
export class TornadoCash4Deposit extends ethereum.Event {
  get params(): TornadoCash4Deposit__Params {
    return new TornadoCash4Deposit__Params(this);
  }
}

export class TornadoCash4Deposit__Params {
  _event: TornadoCash4Deposit;

  constructor(event: TornadoCash4Deposit) {
    this._event = event;
  }
...
export class TornadoCash4Withdrawal extends ethereum.Event {
  get params(): TornadoCash4Withdrawal__Params {
    return new TornadoCash4Withdrawal__Params(this);
  }
}

export class TornadoCash4Withdrawal__Params {
  _event: TornadoCash4Withdrawal;

  constructor(event: TornadoCash4Withdrawal) {
    this._event = event;
  }
...
export class TornadoCash4 extends ethereum.SmartContract {
  static bind(address: Address): TornadoCash4 {
    return new TornadoCash4("TornadoCash4", address);
  }
  ...
  isMigrated(): boolean {
    let result = super.call("isMigrated", "isMigrated():(bool)", []);

    return result[0].toBoolean();
  }

  try_isMigrated(): ethereum.CallResult<boolean> {
    let result = super.tryCall("isMigrated", "isMigrated():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class InitializeTreeForMigrationCall extends ethereum.Call {
  get inputs(): InitializeTreeForMigrationCall__Inputs {
    return new InitializeTreeForMigrationCall__Inputs(this);
  }

  get outputs(): InitializeTreeForMigrationCall__Outputs {
    return new InitializeTreeForMigrationCall__Outputs(this);
  }
}

export class InitializeTreeForMigrationCall__Inputs {
  _call: InitializeTreeForMigrationCall;

  constructor(call: InitializeTreeForMigrationCall) {
    this._call = call;
  }

  get _filledSubtrees(): Array<Bytes> {
...
export class InitializeTreeForMigrationCall__Outputs {
  _call: InitializeTreeForMigrationCall;
...
export class FinishMigrationCall extends ethereum.Call {
  get inputs(): FinishMigrationCall__Inputs {
    return new FinishMigrationCall__Inputs(this);
  }

  get outputs(): FinishMigrationCall__Outputs {
    return new FinishMigrationCall__Outputs(this);
  }
}

export class FinishMigrationCall__Inputs {
  _call: FinishMigrationCall;

  constructor(call: FinishMigrationCall) {
    this._call = call;
  }
}

export class FinishMigrationCall__Outputs {
  _call: FinishMigrationCall;
...
export class MigrateStateCall extends ethereum.Call {
  get inputs(): MigrateStateCall__Inputs {
    return new MigrateStateCall__Inputs(this);
  }

  get outputs(): MigrateStateCall__Outputs {
    return new MigrateStateCall__Outputs(this);
  }
}

export class MigrateStateCall__Inputs {
  _call: MigrateStateCall;

  constructor(call: MigrateStateCall) {
    this._call = call;
  }

  get _commitments(): Array<Bytes> {
    return this._call.inputValues[0].value.toBytesArray();
  }

  get _nullifierHashes(): Array<Bytes> {
    return this._call.inputValues[1].value.toBytesArray();
  }
}

export class MigrateStateCall__Outputs {
  _call: MigrateStateCall;
